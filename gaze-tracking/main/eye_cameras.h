...
public:
	...
	EyeCamera(const std::string file_name, int apiPreference, bool is_flipped=false);
	void init(const int cam_id, bool is_flipped = false);
	void init(const std::string file_name, bool is_flipped=false);
	void init(const std::string file_name, int apiPreference, bool is_flipped=false);
